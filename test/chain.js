...
fixtures.forEach(function(f) {
  ...
  test("clone", function(t) {
    ...
    t.notEqual(
      chain.addresses,
      clone.addresses,
      "address arrays are different objects"
    );
    ...
    t.same(
      chain.addressFunction,
      clone.addressFunction,
      "address function is copied"
    );
    ...
    t.notSame(
      chain.addresses,
      clone.addresses,
      "address array unchanged by mutation"
    );
  ...
  test("get", function(t) {
    ...
    t.equal(
      chain.get(),
      f.addresses[f.addresses.length - 1],
